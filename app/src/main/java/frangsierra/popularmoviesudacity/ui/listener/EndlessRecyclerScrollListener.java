package frangsierra.popularmoviesudacity.ui.listener;
...
/**
 * Custom {@link android.support.v7.widget.RecyclerView.OnScrollListener} which throw a custom callback call
 * when the user's have a custom {@link #visibleThreshold number} of views below his current position in the
 * {@link RecyclerView}.
 * <p>
...
public abstract class EndlessRecyclerScrollListener extends RecyclerView.OnScrollListener {
   ...
   protected EndlessRecyclerScrollListener(GridLayoutManager layoutManager) {
      this.mLayoutManager = layoutManager;
